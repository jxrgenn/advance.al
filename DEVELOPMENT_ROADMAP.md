...
**Last Updated:** May 14, 2026 — PR-F: parse-resume regen trigger + smart notification cap + per-jobseeker 2h digest queue (see "PR-F" section below). May 8, 2026 (Phase 28 — coverage push: 7 new tests for setTimeout batch-delay + upload 503 + email misc; istanbul ignores added for genuinely-unreachable production-only code with WHY justifications; cov7 measurement still pending due to teardown hang)
