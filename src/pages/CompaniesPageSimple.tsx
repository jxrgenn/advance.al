      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.success && data.data.companies.length > 0) {
            ...
            const transformedCompanies = data.data.companies.map((company: any) => ({
              _id: company._id,
              name: company.profile?.employerProfile?.companyName || 'Kompani e panjohur',
              city: company.profile?.location?.city || 'N/A',
              industry: company.profile?.employerProfile?.industry || 'Tjetër',
              activeJobs: company.activeJobsCount || 0,
              verified: company.profile?.employerProfile?.verified || false,
        ...
        <div className="container mx-auto px-4">
          {loading ? (
            ...
            <>
              ...
              <Card key={company._id} className="p-6 hover:border-primary/50 transition-colors">
