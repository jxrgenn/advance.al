    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8">
        ...
        <Tabs defaultValue="jobs" className="space-y-6">
          <TabsList>
            <TabsTrigger value="jobs">Punët e Mia</TabsTrigger>
            <TabsTrigger value="applicants">Aplikuesit</TabsTrigger>
                      ...
                      <div key={job._id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            {job.location?.city}, {job.location?.region} • {job.jobType} • {job.applicationCount || 0} aplikues
                          </div>
                        ...
                        <div className="flex items-center gap-2">
                          <Button size="sm" variant="outline" onClick={() => window.open(`/jobs/${job._id}`, '_blank')}>
                            <Eye className="h-4 w-4" />
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => handleJobAction('edituar', job._id)}>
                            <Edit className="h-4 w-4" />
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => handleJobAction('fshirë', job._id)}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium">Informacion Bazë</h4>
                      
                      {selectedApplication.jobSeekerId.profile.jobSeekerProfile.title && (
                        <div>
                          <Label className="text-sm font-medium">Pozicioni i Dëshiruar</Label>
                          <p className="text-sm">{selectedApplication.jobSeekerId.profile.jobSeekerProfile.title}</p>
                        </div>
                      )}
                      
                      {selectedApplication.jobSeekerId.profile.jobSeekerProfile.experience && (
                        <div>
                          <Label className="text-sm font-medium">Përvojë</Label>
                          <p className="text-sm">{selectedApplication.jobSeekerId.profile.jobSeekerProfile.experience}</p>
                        </div>
                      )}
                      
                      {selectedApplication.jobSeekerId.profile.jobSeekerProfile.availability && (
                        <div>
                          <Label className="text-sm font-medium">Disponueshmëria</Label>
                          <p className="text-sm">
                      ...
                      {selectedApplication.jobSeekerId.profile.location && (
                        <div>
                          ...
                          <p className="text-sm">{selectedApplication.jobSeekerId.profile.location.city}, {selectedApplication.jobSeekerId.profile.location.region}</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-3">
                      {selectedApplication.jobSeekerId.profile.jobSeekerProfile.skills && selectedApplication.jobSeekerId.profile.jobSeekerProfile.skills.length > 0 && (
                        <div>
                          <Label className="text-sm font-medium">Aftësitë</Label>
